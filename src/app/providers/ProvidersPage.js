                ...
                <div>
                    ...
                    <ComposedModal open={this.state.isModalOpen} className='pui-confirm-modal'>
                        <ModalHeader
                            title={
                                <span>
                                    <Icon name='warning--glyph' fill='#EFC100' width='24' height='24' />&nbsp; Before
                                    You Proceed
                                </span>
                            }
                        />
                        <ModalBody>
                            <div className='bx--modal-content__text'>
                                <p>
                                    Please make sure you have received sufficient information from one of the Advisors
                                    or the Legal firms listed below or your own advisor before you proceed with the
                                    token creation.
                                </p>
                            </div>
                        </ModalBody>
                    ...
                    <div className='remark'>
                        ...
                        <div>
                            None of your data entered in the application form(s) is stored on Polymath servers or shared
                            with any third party other than the firm(s) you decide to apply for.
                        </div>
                    </div>
                    ...
                    <div className='bx--row'>
                        <div className='bx--col-xs-7'>
                            <h3 className='pui-h3'>
                                Your Polymath dashboard is integrated with several providers to streamline your
                                on-boarding process and access to their services. The information you enter in each
                                associated form will be sent automatically to the firm(s) you apply for. Upon review of
                                your information, the firm(s) will contact you directly to establish the applicable next
                                steps.<br />
                                <br />
                                To get started, please select an Advisory provider, a Legal provider or both. Note that
                                you don’t need to select all at the same time nor have any obligation to select any of
                                the providers below. You can always elect to use your own.
                            </h3>
                        </div>
                            ...
                            >
                                <div>
                                    ...
                                    <div className='providers-controls'>
                                        ...
                                        <Button kind='secondary' onClick={() => this.handleIHaveMyOwn(cat.id)}>
                                            I have my own
                                        </Button>
                                    </div>
