...
const providers: Array<ServiceProvider> = [
  ...
  // },
  {
    ...
    desc:
      'Genesis Block is a venture production studio focused on developing decentralized protocols, ' +
  ...
  // LEGAL
  {
    ...
    desc:
      'As a leading Canadian law firm with a focus on all principal areas of business law, we advise on a diverse' +
  ...
  },
  {
    ...
    desc:
      'FisherBroyles, LLP is a full-service law firm for the twenty-first century. Our Law Firm 2.0® business ' +
  ...
  },
  {
    ...
    desc:
      'Radix Law offers legal services in the fields of business law, commercial litigation, bankruptcy, real ' +
  ...
  },
  {
    ...
    desc:
      "Founded in 1951, Paul Hastings has grown strategically to anticipate and respond to our clients' needs " +
  ...
  },
  {
    ...
    desc:
      'As a leading Canadian law firm with a focus on all principal areas of business law, we advise on a ' +
  ...
  // MARKETING
  {
    ...
    desc:
      'Built through insights gained from marketing the industry’s most successful equity crowdfunding ' +
  ...
  },
  {
    ...
    desc:
      'Taurus Visiwon specializes in identifying your unique selling points and builds a full-service marketing ' +
