...
const providers: Array<ServiceProvider> = [
  ...
  // },
  {
    ...
    desc:
      'Genesis Block is a venture production studio focused on developing decentralized protocols, infrastructure, ' +
  ...
  },
  {
    ...
    desc:
      "Founded in 1951, Paul Hastings has grown strategically to anticipate and respond to our clients' needs in " +
  ...
  // MARKETING
  {
    ...
    desc:
      'Built through insights gained from marketing the industry’s most successful equity crowdfunding campaigns, ' +
