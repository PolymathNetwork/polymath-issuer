				...
				<div>
					...
					<ComposedModal open={this.state.isModalOpen} className='pui-confirm-modal'>
						<ModalHeader
							...
							title={
								<span>
									<Icon name='warning--glyph' fill='#E71D32' width='24' height='24' />&nbsp; Before
						...
						<ModalBody>
							<div className='bx--modal-content__text'>
								<p>
									...
									violating any trademarks. Once you hit &laquo;CONFIRM&raquo;, your Token will be
									created on the blockchain and will be immutable. Any change will require that you
									start the process over. If you wish to review your information, please select
									&laquo;CANCEL&raquo;.
								</p>
							</div>
						</ModalBody>
											...
											<div className='bx--row'>
												<div className='bx--col-xs-8'>
													...
													<h3 className='pui-h3'>
														...
														expires. If your reservation expire, the token symbol you
														selected will be available for others to claim.
													</h3>
													<h3 className='pui-h3'>
