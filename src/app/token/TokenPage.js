      ...
      <DocumentTitle title={`${token.ticker} Token – Polymath`}>
        <div>
          ...
          <ConfirmModal
            ...
            labelColor='red'
            headerText='Before You Proceed with Token Creation'
            modalIcon='warning--glyph'
            confirmText='Confirm'
            bodyText='Please confirm that all previous information is correct and that you are not violating any trademarks. Once
            you hit &laquo;CONFIRM&raquo;, your Token will be created on the blockchain and will be immutable. Any
            change will require that you start the process over. If you wish to review your information, please select
            &laquo;CANCEL&raquo;.'
                    ...
                    <div className='pui-page-box'>
                      <div className='bx--row'>
                        <div className='bx--col-xs-6'>
                          ...
                          <h3 className='pui-h3'>
                            To proceed with the creation of your security token, we recommend you work with your
                            Advisory to answer the following questions tt:
                          </h3>
                          <br />
