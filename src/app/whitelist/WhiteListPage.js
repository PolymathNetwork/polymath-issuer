...
import { DataTable, PaginationV2, Modal, ModalWrapper, DatePicker, DatePickerInput } from 'carbon-components-react'
        ...
        return (
            <DocumentTitle title='Whitelist – Polymath'>
                                ...
                                <div className={this.props.whitelist.previewCSVShowing ? '' : ''}>
                                    <div>
                                        <p className='csvModalText'>
                                            Add multiple addresses to the whitelist by uploading a comma separated CSV
                                            file. The format should be as follows:
                                        </p>
                                        <p className='csvModalText'>Column 1 &ndash; Ethereum Address.</p>
                                        <p className='csvModalText'>
                                            Column 2 &ndash; Sell Restriction Date mm/dd/yyyy (date when the resale
                                            restrictions should be lifted for that address).
                                        </p>
                                        <p className='csvModalText'>
                                            Column 3 &ndash; Buy Restriction Date mm/dd/yyyy (date when the buy
                                            restrictions should be lifted for that address).
                                        </p>
                                        ...
                                        >
                                            <div className='bx--inline-notification__details'>
                                                <h3 className='bx--inline-notification__title'>REMINDER:</h3>
                                                    ...
                                                    {this.props.whitelist.addresses.map((user, i) => (
                                                        <tr key={uuidv4()} className='csvPreviewTable'>
                                                            <td className='csvTableEthAddress'>
                                                                {addressShortifier(this.props.whitelist.addresses[i])}
                                                            </td>
                ...
                component and shown in console */}
                    ...
                    <DataTable rows={paginatedRows} headers={tableHeaders} render={this.dataTableRender} />
                    <PaginationV2
